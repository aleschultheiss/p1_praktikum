...
Auf dem Mond würde ein Pendel aufgrund der geringeren Beschleunigung ($g_{mond} < g_{erde}$) und der Formel
\begin{equation}
    \begin{split}
        f &= \frac{1}{T} \\
    ...
    \end{split}
\end{equation}
mit einer geringeren Frequenz schwingen als auf der Erde, da $f \propto \sqrt{g}$.
Diese geringere Beschleunigung ist äquivalent zu einem größeren Winkel im Variablen g-Pendel.
